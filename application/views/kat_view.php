...
<div class="col-lg-12 stretch-card">
 <div class="card">
   <div class="card-body">
     <h4 class="card-title">Tables Kategori</h4>
           ...
           <?php
                   ...
                   foreach ($kategori as $b) {
                     ...
                     <td>
                      ...
                      <a href="#" onclick="prepare_update_kat('.$b->id_kat.')" data-toggle="modal" data-target="#Ubah" class="btn btn-warning">Ubah</a>
                      <a href="'.base_url().'index.php/kat/hapus/'.$b->id_kat.'"class="btn btn-danger btn-md" onclick="return confirm(\'Anda yakin Ingin Menghapus Data\')">Hapus</a> </td>
                     </tr>';
                   }
                   ?>
         </tbody>
...
<h4 class="modal-title" id="myModalLabel">Add  kat</h4>
</div>
...
<h4 class="modal-title" id="myModalLabel">Edit kat</h4>
</div>
<div class="modal-body">
